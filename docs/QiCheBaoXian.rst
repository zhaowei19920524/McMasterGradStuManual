...
- TD汽车保险费用的支付比较自由，在和客服打电话的过程中，客服会问你支付的时间，是想一次付清，还是按月支付。如果是按月支付，每个月哪一天付款。但需要注意的是：如果是分期付款，每个月需要多支付1.3%的installment fee。
...
- 激活：需要activation code。这个激活码会在保险生效当天的某个时间发给你。收到之后应尽快激活使用。
- 手机App：
