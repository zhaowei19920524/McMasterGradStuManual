...
提交申请前需要开具的材料
----------------------------------------------------------------
1. Enrolment Letter：在读证明。请务必去学院办公室或学校的Office of the Registrar（GH108）开具，并且要明确指出，开具的材料上需要有预计的毕业时间（至少精确到月份）。请勿使用mosaic自助服务系统开具，那上面生成的文件没有标明毕业时间。https://registrar.mcmaster.ca/services/enrolment-verification/
